  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="overflow-y-auto">
        <ProductFormContent
          // This key forces React to fully remount all state when
          // switching between products (edit→edit, edit→new, new→edit)
          key={product?.id ?? "new"}
          product={product}
          brands={brands}
...
function ProductFormContent({
  ...
  // ── Image state (freshly initialized per product key) ──
